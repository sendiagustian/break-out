            ...
            <div class="row">
                <div class="col-xs-12 col-sm-3 col-md-6">
                    <div class="footer--widget-content">
                        <h3>Our address</h3>
                        <p>Merdeka Street 22<br> Bandung, Indonesia</p>
                ...
                <div class="col-xs-12 col-sm-3 col-md-6">
                    <div class="footer--widget-content">
                        <h3>Contact us</h3>
                        <p class="mb-0"><a href='mailto:break-out@email.com'>Email Us</a></p>
                        <p class="mb-0">( 0261 ) 244533</p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <span>&copy; 2019 Break-out, With <i class="fa fa-heart"></i> by Alya Zenita
                </div>
            </div>
        </div>
        <!-- .container end -->
